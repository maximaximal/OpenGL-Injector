...
#define CHECK_GL_FUNC_PTR(PTR)                                                 \
    if (PTR == 0)                                                              \
        printf("The function " #PTR " could not be read!\n");

/**
 * @brief Sets the state of the specified GL attribute, if the current value is
...
static void normalizeGLState() {
    ...
    setGLAttr(GL_POLYGON_OFFSET_POINT, GL_FALSE,
              &stateBank->polygonOffsetPoint);
    ...
    setGLAttr(GL_SAMPLE_ALPHA_TO_COVERAGE, GL_FALSE,
              &stateBank->sampleAlphaToCoverage);
    ...
    setGLAttr(GL_TEXTURE_CUBE_MAP_SEAMLESS, GL_FALSE,
              &stateBank->textureCubeMapSeamless);
    setGLAttr(GL_PROGRAM_POINT_SIZE, GL_FALSE, &stateBank->programPointSize);

    // Buffer State
    glGetIntegerv_ptr(GL_PIXEL_UNPACK_BUFFER_BINDING,
    ...
    glGetIntegerv_ptr(GL_ELEMENT_ARRAY_BUFFER_BINDING,
                      &stateBank->elementArrayBufferBinding);
    glGetIntegerv_ptr(GL_READ_FRAMEBUFFER_BINDING,
                      &stateBank->readFramebufferBinding);
    glGetIntegerv_ptr(GL_DRAW_FRAMEBUFFER_BINDING,
                      &stateBank->drawFramebufferBinding);
    ...
    // This was a function call in the original code, but it was already made
    // before,
...
static void resetGLState() {
    ...
    glBindBuffer_ptr(GL_ELEMENT_ARRAY_BUFFER,
                     stateBank->elementArrayBufferBinding);
    glBindFramebuffer_ptr(GL_DRAW_FRAMEBUFFER,
                          stateBank->drawFramebufferBinding);
    glBindFramebuffer_ptr(GL_READ_FRAMEBUFFER,
                          stateBank->readFramebufferBinding);
    ...
    resetGLAttr(GL_TEXTURE_CUBE_MAP_SEAMLESS,
                stateBank->textureCubeMapSeamless);
    resetGLAttr(GL_PROGRAM_POINT_SIZE, stateBank->programPointSize);

    // Misc
    // glUseProgram_ptr(stateBank->currentProgram);
    glBlendColor_ptr(stateBank->blendColor[0], stateBank->blendColor[1],
                     stateBank->blendColor[2], stateBank->blendColor[3]);
...
void glXSwapBuffers(Display *dpy, GLXDrawable drawable) {
    ...
    if (glGetBooleanv_ptr == 0) {
        ...
        glGetBooleanv_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetBooleanv");
        CHECK_GL_FUNC_PTR(glGetBooleanv_ptr)
        glGetIntegerv_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetIntegerv");
        CHECK_GL_FUNC_PTR(glGetIntegerv_ptr)
        glGetFloatv_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetFloatv");
        CHECK_GL_FUNC_PTR(glGetFloatv_ptr)
        glGetShaderInfoLog_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetShaderInfoLog");
        glGetProgramInfoLog_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetProgramInfoLog");
        CHECK_GL_FUNC_PTR(glGetProgramInfoLog_ptr)
        glGetError_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetError");
        CHECK_GL_FUNC_PTR(glGetError_ptr)

        glActiveTexture_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glActiveTexture");
        glBindBuffer_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBindBuffer");
        glBindFramebuffer_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBindFramebuffer");
        glBindTexture_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBindTexture");
        glBindVertexArray_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBindVertexArray");
        glBindSampler_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBindSampler");
        glBindAttribLocation_ptr = glXGetProcAddress_ptr(
            (const unsigned char *)"glBindAttribLocation");
        CHECK_GL_FUNC_PTR(glBindAttribLocation_ptr)
        glBlendColor_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBlendColor");
        glBlendFunc_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBlendFunc");
        glColorMask_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glColorMask");
        glColorMaski_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glColorMaski");
        glFrontFace_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glFrontFace");
        glPixelStorei_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glPixelStorei");
        glPixelStoref_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glPixelStoref");
        glPolygonMode_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glPolygonMode");
        glTexParameterf_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glTexParameterf");
        glTexParameteri_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glTexParameteri");
        glUseProgram_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glUseProgram");

        glEnable_ptr = glXGetProcAddress_ptr((const unsigned char *)"glEnable");
        glDisable_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glDisable");
        glIsEnabled_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glIsEnabled");
        glIsEnabledi_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glIsEnabledi");

        glCreateShader_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glCreateShader");
        CHECK_GL_FUNC_PTR(glCreateShader_ptr)
        glShaderSource_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glShaderSource");
        CHECK_GL_FUNC_PTR(glShaderSource_ptr)
        glCompileShader_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glCompileShader");
        CHECK_GL_FUNC_PTR(glCompileShader_ptr)
        glDeleteShader_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glDeleteShader");
        CHECK_GL_FUNC_PTR(glDeleteShader_ptr)
        glCreateProgram_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glCreateProgram");
        CHECK_GL_FUNC_PTR(glCreateProgram_ptr)
        glAttachShader_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glAttachShader");
        CHECK_GL_FUNC_PTR(glAttachShader_ptr)
        glLinkProgram_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glLinkProgram");
        CHECK_GL_FUNC_PTR(glLinkProgram_ptr)
        glGetProgramiv_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetProgramiv");
        CHECK_GL_FUNC_PTR(glGetProgramiv_ptr)
        glGetShaderiv_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetShaderiv");
        CHECK_GL_FUNC_PTR(glGetShaderiv_ptr)
        glDeleteProgram_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glDeleteProgram");
        CHECK_GL_FUNC_PTR(glDeleteProgram_ptr)
        glGetAttribLocation_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGetAttribLocation");
        CHECK_GL_FUNC_PTR(glGetAttribLocation_ptr)
        glGetUniformLocation_ptr = glXGetProcAddress_ptr(
            (const unsigned char *)"glGetUniformLocation");
        CHECK_GL_FUNC_PTR(glGetUniformLocation_ptr)
        glGenTextures_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGenTextures");
        CHECK_GL_FUNC_PTR(glGenTextures_ptr)
        glGenBuffers_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGenBuffers");
        CHECK_GL_FUNC_PTR(glGenBuffers_ptr)
        glGenVertexArrays_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glGenVertexArrays");
        CHECK_GL_FUNC_PTR(glGenVertexArrays_ptr)
        glBufferData_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBufferData");
        CHECK_GL_FUNC_PTR(glBufferData_ptr)
        glBufferSubData_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glBufferSubData");
        CHECK_GL_FUNC_PTR(glBufferSubData_ptr)
        glTexImage2D_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glTexImage2D");
        CHECK_GL_FUNC_PTR(glTexImage2D_ptr)
        glTexSubImage2D_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glTexSubImage2D");
        CHECK_GL_FUNC_PTR(glTexSubImage2D_ptr)
        glUniform1i_ptr =
            glXGetProcAddress_ptr((const unsigned char *)"glUniform1i");
        CHECK_GL_FUNC_PTR(glUniform1i_ptr)
        glVertexAttribPointer_ptr = glXGetProcAddress_ptr(
            (const unsigned char *)"glVertexAttribPointer");
        CHECK_GL_FUNC_PTR(glVertexAttribPointer_ptr)
        glEnableVertexAttribArray_ptr = glXGetProcAddress_ptr(
            (const unsigned char *)"glEnableVertexAttribArray");
        CHECK_GL_FUNC_PTR(glVertexAttribPointer_ptr)
