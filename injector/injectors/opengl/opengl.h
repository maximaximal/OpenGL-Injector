...
typedef void (*glShaderSource_ptr_t)(GLuint shader, GLsizei count, const GLchar **string, const GLint *length);
...
typedef void (*glGetProgramiv_ptr_t)(GLuint program, GLenum pname, GLint *params);
...
typedef void (*glTexSubImage2D_ptr_t)(GLenum target, GLint level, GLsizei x, GLsizei y, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * data);
